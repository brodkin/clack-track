...
describe('registerCoreContent', () => {
  ...
  describe('P2 Generator Registration', () => {
    ...
    it('should register all P2 generators with NORMAL priority', () => {
      ...
      // hotTake, novelInsight, languageLesson, alienFieldReport, happyToSeeMe, yoMomma, issObserver, oneStarReview, houseboyVent = 21
  ...
  describe('Complete Registration', () => {
    ...
    it('should maintain correct priority distribution', () => {
      ...
      // timePerspective, hotTake, novelInsight, languageLesson, alienFieldReport, happyToSeeMe, yoMomma, issObserver, oneStarReview, houseboyVent
