...
// Mock frame-generator module - @swc/jest compiles imports as non-configurable,
// preventing jest.spyOn from redefining module exports
const actualFrameGenerator = jest.requireActual<
  typeof import('../../../../src/content/frame/frame-generator.js')
>('../../../../src/content/frame/frame-generator.js');
jest.mock('../../../../src/content/frame/frame-generator.js', () => ({
  ...jest.requireActual<typeof import('../../../../src/content/frame/frame-generator.js')>(
    '../../../../src/content/frame/frame-generator.js'
  ),
  generateFrame: jest.fn((...args: unknown[]) =>
    actualFrameGenerator.generateFrame(
      ...(args as [import('../../../../src/content/frame/frame-generator.js').FrameOptions])
    )
  ),
}));
...
describe('FrameDecorator', () => {
  ...
  describe('Error Handling and Fallback Logic', () => {
    it('should use fallback layout if generateFrame throws unexpected error', async () => {
      ...
      const generateFrameSpy = (
        frameGeneratorModule.generateFrame as jest.Mock
      ...
      // Restore original pass-through implementation
      (frameGeneratorModule.generateFrame as jest.Mock).mockImplementation((...args: unknown[]) =>
        actualFrameGenerator.generateFrame(
          ...(args as [import('../../../../src/content/frame/frame-generator.js').FrameOptions])
        )
      );
  ...
  describe('Format Options Wiring', () => {
    ...
    it('should pass formatOptions to generateFrame', async () => {
      const generateFrameSpy = frameGeneratorModule.generateFrame as jest.Mock;
      const decorator = new FrameDecorator();
      const formatOptions = {
      ...
      // Restore pass-through to actual implementation
      (frameGeneratorModule.generateFrame as jest.Mock).mockImplementation((...args: unknown[]) =>
        actualFrameGenerator.generateFrame(
          ...(args as [import('../../../../src/content/frame/frame-generator.js').FrameOptions])
        )
