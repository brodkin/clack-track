...
// Mock the AI module - @swc/jest compiles imports as non-configurable,
...
const createAIProviderMock = aiModule.createAIProvider as jest.Mock;
...
describe('test-ai command', () => {
  ...
  describe('Provider Selection', () => {
    it('should test OpenAI when provider is "openai"', async () => {
      ...
      createAIProviderMock.mockReturnValue(mockProvider);
      ...
      expect(createAIProviderMock).toHaveBeenCalledTimes(1);
    });
    ...
    it('should test both providers when provider is "all"', async () => {
      ...
      createAIProviderMock.mockReturnValueOnce(mockOpenAI).mockReturnValueOnce(mockAnthropic);
      ...
      expect(createAIProviderMock).toHaveBeenCalledTimes(2);
    });
