...
// Note: With @swc/jest, jest.mock() factory functions cannot reference variables declared
// outside via const/let (TDZ issue). We use var for hoisting compatibility, or inline values.
var mockConfig: Record<string, unknown> = {
  nodeEnv: 'test',
  port: 3000,
...
// Mock AI provider
var mockProvider: Record<string, jest.Mock> = {
  generate: jest.fn(),
