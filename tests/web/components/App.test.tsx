...
describe('App Component', () => {
  ...
  it.skip('renders Welcome page on default route', async () => {
    render(
    ...
    // Wait for the actual content to load (not just "Latest Content" heading)
    // The Welcome component displays "Generated by: test" when content loads
    await screen.findByText(/Generated by:/i);
