...
export const TOPIC_DOMAINS = {
  ...
  SOCIAL: [
    ...
    'voicemails nobody leaves',
    'waving at someone who wasnt waving at you',
  ...
  DATING: [
    ...
    'overanalyzing texts',
    'mutual friends stalking',
    'the talking stage',
  ],
  FOOD_AND_COOKING: [
    'leftovers you swear youll eat',
    'grocery store without a list',
    'recipe serving sizes',
    'spice cabinet ambition',
    'delivery app guilt',
    'expiration date optimism',
    'meal planning versus reality',
