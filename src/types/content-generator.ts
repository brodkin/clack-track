 ...
 * @property {Record<string, unknown>} [metadata] - Optional additional metadata about generation
 *
 * @example
 * ```typescript
...
export interface GeneratedContent {
  ...
  /** Optional additional metadata (AI model, parameters, etc.) */
